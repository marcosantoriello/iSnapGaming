...
%%nemmeno la sezione nell'indice
    ...
    Nella schermata di gestione delle recensioni, vengono elencate in una tabella tutte le recensioni dei prodotti che sono in stato "in attesa" da parte degli utenti. Per ciascuna recensione, il gestore può decidere se approvarla o meno, verificando se rispetta un linguaggio appropriato e non contiene contenuti offensivi. Questa azione può essere eseguita tramite un apposito bottone.
    Indipendentemente dalla scelta effettuata, la recensione non sarà più visibile tra quelle da accettare o rifiutare.
